<?php if(isset($_SESSION['user_name'])): ?>
    <li class="profile-link" style="background: rgba(255,255,255,0.05); padding: 5px 10px; border-radius: 5px; margin-bottom: 2px; list-style: none;">
...
<?php else: ?>
    <li style="list-style: none; margin-bottom: 2px;"><a href="../login.php" style="color: #3498db !important; text-decoration: none; padding: 5px 0; display: block;"><i class="fa fa-sign-in"></i> Bejelentkezés</a></li>
    <li style="list-style: none; margin-bottom: 2px;"><a href="../reg_id.php" style="text-decoration: none; padding: 5px 0; display: block;"><i class="fa fa-user-plus"></i> Regisztráció</a></li>
<?php endif; ?>

<li style="height: 1px; background: rgba(255,255,255,0.2); margin: 5px 0; list-style: none;"></li>

<li style="list-style: none; margin-bottom: -5px;"><a href="../index.php" style="padding: 5px 0; display: block; text-decoration: none;">Kezdőlap</a></li>
<li style="list-style: none; margin-bottom: -5px;"><a href="latnivalok.php" style="padding: 5px 0; display: block; text-decoration: none;">Látnivalók</a></li>
