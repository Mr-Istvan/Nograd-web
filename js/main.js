jQuery(document).ready(function($) {
    ...
    // Mobil menü lenyitása és bezárása
...
$('#main-nav a').on('click', function() {
    ...
    nav: true, 
    dots: true,
    // Csak a tiszta nyilakat hagyjuk meg, a CSS fogja formázni
    navText: ["&#10094;", "&#10095;"], 
    responsive: {
        0: { 
            items: 1, 
...
}); // <--- EZ HIÁNYZOTT! Ez zárja le a legelső sorban megnyitott jQuery blokkot.
